...
class printStateMachine(object):
    ...
    def generate_blind_trajectory(self):
        ...
        pose1 = generate_pose(0, 0, 0.1)
        # pose2 = generate_pose(-0.2, 0, 0.1)
        # pose3 = generate_pose(1.5, 0, 0.1)
        # pose4 = generate_pose(1.5, 0, 0.48)
        # pose5 = generate_pose(1.3, 0, 0.48)
        # pose6 = generate_pose(1.1, 0, 0.48)
        # pose7 = generate_pose(0.9, 0, 0.48)
        # pose8 = generate_pose(0.7, 0, 0.48)
        # pose9 = generate_pose(0.5, 0, 0.48)
        # pose10 = generate_pose(0.3, 0, 0.48)
        # pose11 = generate_pose(0.1, 0, 0.48)
        # pose12 = generate_pose(-0.1, 0, 0.48)
        # pose13 = generate_pose(-0.3, 0, 0.48)

        self.traj_blind.pause(pose1, pause_time)
